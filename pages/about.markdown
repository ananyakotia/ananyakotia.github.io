...
<!-- Added scoped inline styles on the About page to render hyperlinks in blue with underline and a darker hover state for better affordance. 

Wrapped the About page content in a dedicated container to confine the new link styling to that page only. -->
